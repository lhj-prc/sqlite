...
#line 3661 "parse.sql"
    ...
    case 322: /* range_or_rows ::= RANGE|ROWS|GROUPS */
...
#line 186 "parse.y"
        {
            sqlite3StartTable(pParse, &yymsp[-1].minor.yy0, &yymsp[0].minor.yy0, yymsp[-4].minor.yy394, 0, 0,
                              yymsp[-2].minor.yy394);
        }
#line 3703 "parse.sql"
        break;
...
#line 3708 "parse.sql"
    ...
    case 62: /* init_deferred_pred_opt ::= */
...
#line 362 "parse.y"
        {
            sqlite3AddDefaultValue(pParse, yymsp[0].minor.yy528, yymsp[-1].minor.yy0.z,
...
#line 366 "parse.y"
        {
            sqlite3AddDefaultValue(pParse, yymsp[0].minor.yy528, yymsp[-2].minor.yy0.z,
                                   &yymsp[-1].minor.yy0.z[yymsp[-1].minor.yy0.n]);
        }
#line 3849 "parse.sql"
        break;
...
#line 413 "parse.y"
        {
            ...
            yymsp[-1].minor.yy231.mask = 0x000000;
        }
#line 3935 "parse.sql"
        break;
...
#line 414 "parse.y"
        {
            ...
            yymsp[-2].minor.yy231.mask = 0x000000;
        }
#line 3940 "parse.sql"
        break;
...
#line 415 "parse.y"
        {
            ...
            yymsp[-2].minor.yy231.mask = 0x0000ff;
        }
#line 3945 "parse.sql"
        break;
...
#line 416 "parse.y"
        {
            ...
            yymsp[-2].minor.yy231.mask = 0x00ff00;
        }
#line 3950 "parse.sql"
        break;
...
#line 3980 "parse.sql"
    ...
    case 76: /* orconf ::= OR resolvetype */
        yytestcase(yyruleno==76);
    case 171: /* insert_cmd ::= INSERT orconf */
...
#line 3987 "parse.sql"
    ...
    case 80: /* ifexists ::= IF EXISTS */
        yytestcase(yyruleno==80);
    case 215: /* between_op ::= NOT BETWEEN */
        yytestcase(yyruleno==215);
    case 218: /* in_op ::= NOT IN */
        yytestcase(yyruleno==218);
    case 244: /* collate ::= COLLATE ID|STRING */
...
#line 481 "parse.y"
        {
            sqlite3CreateView(pParse, &yymsp[-8].minor.yy0, &yymsp[-4].minor.yy0, &yymsp[-3].minor.yy0, yymsp[-2].minor.yy322,
                              yymsp[0].minor.yy47, yymsp[-7].minor.yy394, yymsp[-5].minor.yy394);
        }
#line 4066 "parse.sql"
        break;
...
#line 597 "parse.y"
        {
            yymsp[-8].minor.yy47 = sqlite3SelectNew(pParse, yymsp[-6].minor.yy322, yymsp[-5].minor.yy131, yymsp[-4].minor.yy528,
                                                    yymsp[-3].minor.yy322, yymsp[-2].minor.yy528, yymsp[-1].minor.yy322, yymsp[-7].minor.yy394, yymsp[0].minor.yy528);
        }
#line 4147 "parse.sql"
        break;
...
#line 603 "parse.y"
        {
            yymsp[-9].minor.yy47 = sqlite3SelectNew(pParse, yymsp[-7].minor.yy322, yymsp[-6].minor.yy131, yymsp[-5].minor.yy528,
                                                    yymsp[-4].minor.yy322, yymsp[-3].minor.yy528, yymsp[-1].minor.yy322, yymsp[-8].minor.yy394, yymsp[0].minor.yy528);
...
#line 4192 "parse.sql"
        break;
    case 99: /* sclp ::= */
    case 132: /* orderby_opt ::= */
        yytestcase(yyruleno==132);
    case 142: /* groupby_opt ::= */
        yytestcase(yyruleno==142);
    case 231: /* exprlist ::= */
        yytestcase(yyruleno==231);
    case 234: /* paren_exprlist ::= */
        yytestcase(yyruleno==234);
    case 239: /* eidlist_opt ::= */
...
#line 4229 "parse.sql"
        break;
    case 103: /* as ::= AS nm */
    case 115: /* dbnm ::= DOT nm */
        yytestcase(yyruleno==115);
    case 255: /* plus_num ::= PLUS INTEGER|FLOAT */
        yytestcase(yyruleno==255);
    case 256: /* minus_num ::= MINUS INTEGER|FLOAT */
...
#line 696 "parse.y"
        {
            if (ALWAYS(yymsp[-1].minor.yy131 && yymsp[-1].minor.yy131->nSrc>0)) {
...
#line 700 "parse.y"
        {
            yymsp[-4].minor.yy131 = sqlite3SrcListAppendFromTerm(pParse, yymsp[-4].minor.yy131, &yymsp[-3].minor.yy0,
                                    &yymsp[-2].minor.yy0, &yymsp[-1].minor.yy0, 0, &yymsp[0].minor.yy561);
        }
#line 4265 "parse.sql"
        break;
...
#line 703 "parse.y"
        {
            yymsp[-5].minor.yy131 = sqlite3SrcListAppendFromTerm(pParse, yymsp[-5].minor.yy131, &yymsp[-4].minor.yy0,
                                    &yymsp[-3].minor.yy0, &yymsp[-2].minor.yy0, 0, &yymsp[0].minor.yy561);
...
#line 707 "parse.y"
        {
            yymsp[-7].minor.yy131 = sqlite3SrcListAppendFromTerm(pParse, yymsp[-7].minor.yy131, &yymsp[-6].minor.yy0,
                                    &yymsp[-5].minor.yy0, &yymsp[-1].minor.yy0, 0, &yymsp[0].minor.yy561);
...
#line 712 "parse.y"
        {
            yymsp[-5].minor.yy131 = sqlite3SrcListAppendFromTerm(pParse, yymsp[-5].minor.yy131, 0, 0, &yymsp[-1].minor.yy0,
                                    yymsp[-3].minor.yy47, &yymsp[0].minor.yy561);
        }
#line 4288 "parse.sql"
        break;
...
#line 715 "parse.y"
        {
            if (yymsp[-5].minor.yy131==0 && yymsp[-1].minor.yy0.n==0 && yymsp[0].minor.yy561.pOn==0 &&
                yymsp[0].minor.yy561.pUsing==0) {
                yymsp[-5].minor.yy131 = yymsp[-3].minor.yy131;
            } else if (yymsp[-3].minor.yy131->nSrc==1) {
                yymsp[-5].minor.yy131 = sqlite3SrcListAppendFromTerm(pParse, yymsp[-5].minor.yy131, 0, 0, &yymsp[-1].minor.yy0, 0,
                                        &yymsp[0].minor.yy561);
                ...
                yymsp[-5].minor.yy131 = sqlite3SrcListAppendFromTerm(pParse, yymsp[-5].minor.yy131, 0, 0, &yymsp[-1].minor.yy0,
                                        pSubquery, &yymsp[0].minor.yy561);
            }
        }
#line 4323 "parse.sql"
        break;
    case 114: /* dbnm ::= */
    case 129: /* indexed_opt ::= */
...
#line 754 "parse.y"
        {
            ...
            if (IN_RENAME_OBJECT && yylhsminor.yy131) {
...
#line 785 "parse.y"
        {
            yymsp[-3].minor.yy394 = sqlite3JoinType(pParse, &yymsp[-3].minor.yy0, &yymsp[-2].minor.yy0,
...
#line 4418 "parse.sql"
    ...
    case 143: /* groupby_opt ::= GROUP BY nexprlist */
...
#line 4477 "parse.sql"
    ...
    case 152: /* where_opt ::= WHERE expr */
        yytestcase(yyruleno==152);
    case 154: /* where_opt_ret ::= WHERE expr */
        yytestcase(yyruleno==154);
    case 227: /* case_else ::= ELSE expr */
        yytestcase(yyruleno==227);
    case 248: /* vinto ::= INTO expr */
...
#line 953 "parse.y"
        {
            ...
            sqlite3Update(pParse, yymsp[-5].minor.yy131, yymsp[-2].minor.yy322, yymsp[0].minor.yy528, yymsp[-6].minor.yy394, 0, 0,
                          0);
        }
#line 4540 "parse.sql"
        break;
...
#line 981 "parse.y"
        {
            yymsp[-6].minor.yy322 = sqlite3ExprListAppendVector(pParse, yymsp[-6].minor.yy322, yymsp[-3].minor.yy254,
                                    yymsp[0].minor.yy528);
        }
#line 4555 "parse.sql"
        break;
...
#line 995 "parse.y"
        {
            sqlite3Insert(pParse, yymsp[-3].minor.yy131, yymsp[-1].minor.yy47, yymsp[-2].minor.yy254, yymsp[-5].minor.yy394,
                          yymsp[0].minor.yy444);
        }
#line 4578 "parse.sql"
        break;
...
#line 1014 "parse.y"
        {
            yymsp[-11].minor.yy444 = sqlite3UpsertNew(pParse->db, yymsp[-8].minor.yy322, yymsp[-6].minor.yy528,
                                     yymsp[-2].minor.yy322, yymsp[-1].minor.yy528, yymsp[0].minor.yy444);
        }
#line 4600 "parse.sql"
        break;
...
#line 1016 "parse.y"
        {
            yymsp[-8].minor.yy444 = sqlite3UpsertNew(pParse->db, yymsp[-5].minor.yy322, yymsp[-3].minor.yy528, 0, 0,
                                    yymsp[0].minor.yy444);
        }
#line 4605 "parse.sql"
        break;
...
#line 1192 "parse.y"
        {
            ...
            if (bNot) {
                yymsp[-2].minor.yy528 = sqlite3PExpr(pParse, TK_NOT, yymsp[-2].minor.yy528, 0);
            }
            if (yymsp[-2].minor.yy528) {
                yymsp[-2].minor.yy528->flags |= EP_InfixFunc;
            }
        }
#line 4822 "parse.sql"
        break;
...
#line 1202 "parse.y"
        {
            ...
            if (bNot) {
                yymsp[-4].minor.yy528 = sqlite3PExpr(pParse, TK_NOT, yymsp[-4].minor.yy528, 0);
            }
            if (yymsp[-4].minor.yy528) {
                yymsp[-4].minor.yy528->flags |= EP_InfixFunc;
            }
        }
#line 4837 "parse.sql"
        break;
...
#line 1355 "parse.y"
        {
            ...
            if (yymsp[-4].minor.yy528) {
                yymsp[-4].minor.yy528->x.pList = yymsp[-1].minor.yy528 ? sqlite3ExprListAppend(pParse, yymsp[-2].minor.yy322,
                                                 yymsp[-1].minor.yy528) : yymsp[-2].minor.yy322;
                sqlite3ExprSetHeightAndFlags(pParse, yymsp[-4].minor.yy528);
            } else {
...
#line 5055 "parse.sql"
    ...
    case 240: /* eidlist_opt ::= LP eidlist RP */
...
#line 1470 "parse.y"
        {
            yymsp[-4].minor.yy322 = parserAddExprIdListTerm(pParse, yymsp[-4].minor.yy322, &yymsp[-2].minor.yy0,
                                    yymsp[-1].minor.yy394, yymsp[0].minor.yy394);
        }
#line 5091 "parse.sql"
        break;
...
#line 1473 "parse.y"
        {
            yymsp[-2].minor.yy322 = parserAddExprIdListTerm(pParse, 0, &yymsp[-2].minor.yy0, yymsp[-1].minor.yy394,
                                    yymsp[0].minor.yy394); /*A-overwrites-Y*/
        }
#line 5098 "parse.sql"
        break;
...
#line 1531 "parse.y"
        {
            sqlite3BeginTrigger(pParse, &yymsp[-7].minor.yy0, &yymsp[-6].minor.yy0, yymsp[-5].minor.yy394, yymsp[-4].minor.yy180.a,
                                yymsp[-4].minor.yy180.b, yymsp[-2].minor.yy131, yymsp[0].minor.yy528, yymsp[-10].minor.yy394, yymsp[-8].minor.yy394);
...
#line 1545 "parse.y"
        {
            yymsp[-2].minor.yy180.a = TK_UPDATE;
...
#line 1603 "parse.y"
        {
            yylhsminor.yy33 = sqlite3TriggerUpdateStep(pParse, &yymsp[-6].minor.yy0, yymsp[-2].minor.yy131, yymsp[-3].minor.yy322,
                              yymsp[-1].minor.yy528, yymsp[-7].minor.yy394, yymsp[-8].minor.yy0.z, yymsp[0].minor.yy522);
        }
#line 5244 "parse.sql"
...
#line 1607 "parse.y"
        {
            yylhsminor.yy33 = sqlite3TriggerInsertStep(pParse, &yymsp[-4].minor.yy0, yymsp[-3].minor.yy254, yymsp[-2].minor.yy47,
                              yymsp[-6].minor.yy394, yymsp[-1].minor.yy444, yymsp[-7].minor.yy522,
                              yymsp[0].minor.yy522); /*yylhsminor.yy33-overwrites-yymsp[-6].minor.yy394*/
        }
#line 5252 "parse.sql"
...
#line 1612 "parse.y"
        {
            yylhsminor.yy33 = sqlite3TriggerDeleteStep(pParse, &yymsp[-3].minor.yy0, yymsp[-1].minor.yy528, yymsp[-5].minor.yy0.z,
                              yymsp[0].minor.yy522);
        }
#line 5258 "parse.sql"
...
#line 1616 "parse.y"
        {
            yylhsminor.yy33 = sqlite3TriggerSelectStep(pParse->db, yymsp[-1].minor.yy47, yymsp[-2].minor.yy522,
                              yymsp[0].minor.yy522); /*yylhsminor.yy33-overwrites-yymsp[-1].minor.yy47*/
        }
#line 5264 "parse.sql"
...
#line 5395 "parse.sql"
    ...
    case 300: /* vtabargtoken ::= lp anylist RP */
...
#line 5402 "parse.sql"
    ...
    case 303: /* with ::= WITH RECURSIVE wqlist */
...
#line 1741 "parse.y"
        {
            yymsp[-5].minor.yy385 = sqlite3CteNew(pParse, &yymsp[-5].minor.yy0, yymsp[-4].minor.yy322, yymsp[-1].minor.yy47,
                                                  yymsp[-3].minor.yy516); /*A-overwrites-X*/
        }
#line 5430 "parse.sql"
        break;
...
#line 1805 "parse.y"
        {
            yymsp[-4].minor.yy41 = sqlite3WindowAssemble(pParse, yymsp[0].minor.yy41, yymsp[-2].minor.yy322, yymsp[-1].minor.yy322,
                                   0);
        }
#line 5479 "parse.sql"
        break;
...
#line 1808 "parse.y"
        {
            yylhsminor.yy41 = sqlite3WindowAssemble(pParse, yymsp[0].minor.yy41, yymsp[-2].minor.yy322, yymsp[-1].minor.yy322,
                                                    &yymsp[-5].minor.yy0);
        }
#line 5486 "parse.sql"
...
#line 5501 "parse.sql"
    ...
    case 336: /* filter_over ::= over_clause */
...
#line 1827 "parse.y"
        {
            yylhsminor.yy41 = sqlite3WindowAlloc(pParse, yymsp[-2].minor.yy394, yymsp[-1].minor.yy595.eType,
                                                 yymsp[-1].minor.yy595.pExpr, TK_CURRENT, 0, yymsp[0].minor.yy516);
        }
#line 5533 "parse.sql"
        yymsp[-2].minor.yy41 = yylhsminor.yy41;
        break;
...
#line 1831 "parse.y"
        {
            yylhsminor.yy41 = sqlite3WindowAlloc(pParse, yymsp[-5].minor.yy394, yymsp[-3].minor.yy595.eType,
                                                 yymsp[-3].minor.yy595.pExpr, yymsp[-1].minor.yy595.eType, yymsp[-1].minor.yy595.pExpr, yymsp[0].minor.yy516);
        }
#line 5541 "parse.sql"
        yymsp[-5].minor.yy41 = yylhsminor.yy41;
        break;
    case 323: /* frame_bound_s ::= frame_bound */
    case 325: /* frame_bound_e ::= frame_bound */
...
#line 5548 "parse.sql"
    ...
    case 326: /* frame_bound_e ::= UNBOUNDED FOLLOWING */
        yytestcase(yyruleno==326);
    case 328: /* frame_bound ::= CURRENT ROW */
...
#line 5573 "parse.sql"
    ...
    case 332: /* frame_exclude ::= CURRENT ROW */
